...
class BudgetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create budget" do
    assert_difference("Budget.count") do
      post budgets_url, params: { budget: { account_id: @budget.account_id, max_amount: @budget.max_amount } }
    end
  ...
  test "should update budget" do
    patch budget_url(@budget), params: { budget: { account_id: @budget.account_id, max_amount: @budget.max_amount } }
